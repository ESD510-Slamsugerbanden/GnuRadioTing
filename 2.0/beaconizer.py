...
class blk(gr.sync_block):  # other base classes are basic_block, decim_block, interp_block
    ...
    def __init__(self, burst_period=1000,bursts = 4, gold_code=1, sps=3):  # only default arguments here
        ...
        self.mycode = np.concatenate([self.mycode, np.zeros(self.minislot*2)]) ##Genererer vores SCHLONG vektor der kan bruges med minislot spacing
