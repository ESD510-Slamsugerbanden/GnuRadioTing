...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.network_udp_sink_0 = network.udp_sink(gr.sizeof_float, 1, '127.0.0.1', 24944, 0, 64, False)
        self.fft_vxx_0 = fft.fft_vcc(2048, True, window.blackmanharris(2048), True, 1)
        self.epy_block_0 = epy_block_0.blk(vectorSize=2048)
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, 2048)
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(2048)
